 ...
 */
class AuditTrail implements Serializable, MultiTenant<AuditTrail> {
  ...
  static constraints = {
    ...
    oldValue(nullable: true, maxSize: 8192)
    newValue(nullable: true, maxSize: 8192)
  ...
  static mapping = {
    ...
    oldValue type: 'text'
    newValue type: 'text'
    tenant index: 'audit_trail_tenant_idx'
